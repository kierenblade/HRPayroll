...
namespace FlourishAPI.Models.Classes
{
    ...
    public class Employee : CRUDAble{
        ...
        [BsonElement("Bank")]
        public FlourishAPI.Models.Classes.Bank Bank { get; set; }
        ...
        {
            return string.Format("{0}-{1}-{2}-{3}-{4}-{5}-{6}", IdNumber, FirstName, LastName, AccountNumber, Salary, Position, EmployeeStatus);
        }
        #endregion
    }
}
