...
namespace FlorishTestEnviroment
{
    class Program
    {
        ...
        {
            Employee e = new Employee() { FirstName = "Wade", LastName = "Martins", AccountNumber = "10101012", Bank = new Bank() { Name = "Absa" } };
            e.InsertDocument();
            ...
            searchFieldsAndCols.Add("FirstName", "Wade");
           // searchFieldsAndCols.Add("Bank.BankName", "Absa");
            List<CRUDAble> eList = e.SearchDocument(searchFieldsAndCols);
